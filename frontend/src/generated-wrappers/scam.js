...
var ScamEvents;
(function (ScamEvents) {
    ScamEvents["Bisect"] = "Bisect";
    ScamEvents["Fill"] = "Fill";
    ScamEvents["FillInternal"] = "FillInternal";
    ScamEvents["OwnershipTransferred"] = "OwnershipTransferred";
    ScamEvents["Price"] = "Price";
})(ScamEvents = exports.ScamEvents || (exports.ScamEvents = {}));
/* istanbul ignore next */
// tslint:disable:no-parameter-reassignment
// tslint:disable-next-line:class-name
var ScamContract = /** @class */ (function (_super) {
    __extends(ScamContract, _super);
    function ScamContract(address, supportedProvider, txDefaults, logDecodeDependencies, deployedBytecode) {
        if (deployedBytecode === void 0) { deployedBytecode = ScamContract.deployedBytecode; }
        var _this = _super.call(this, 'Scam', ScamContract.ABI(), address, supportedProvider, txDefaults, logDecodeDependencies, deployedBytecode) || this;
        _this._methodABIIndex = {};
        utils_1.classUtils.bindAll(_this, ['_abiEncoderByFunctionSignature', 'address', '_web3Wrapper']);
        _this._subscriptionManager = new base_contract_1.SubscriptionManager(ScamContract.ABI(), _this._web3Wrapper);
        ScamContract.ABI().forEach(function (item, index) {
    ...
    ScamContract.deployFrom0xArtifactAsync = function (artifact, supportedProvider, txDefaults, logDecodeDependencies) {
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_d) {
                ...
                return [2 /*return*/, ScamContract.deployAsync(bytecode, abi, provider, txDefaults, logDecodeDependenciesAbiOnly)];
            });
        });
    };
    ScamContract.deployAsync = function (bytecode, abi, supportedProvider, txDefaults, logDecodeDependencies) {
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 3:
                        txReceipt = _a.sent();
                        utils_1.logUtils.log("Scam successfully deployed at " + txReceipt.contractAddress);
                        contractInstance = new ScamContract(txReceipt.contractAddress, provider, txDefaults, logDecodeDependencies);
    ...
    ScamContract.prototype.getFunctionSignature = function (methodName) {
        var index = this._methodABIIndex[methodName];
        var methodAbi = ScamContract.ABI()[index]; // tslint:disable-line:no-unnecessary-type-assertion
        var functionSignature = base_contract_1.methodAbiToFunctionSignature(methodAbi);
        return functionSignature;
    };
    ScamContract.prototype.getABIDecodedTransactionData = function (methodName, callData) {
    ...
    ScamContract.prototype.getABIDecodedReturnData = function (methodName, callData) {
        var functionSignature = this.getFunctionSignature(methodName);
        var self = this;
        var abiEncoder = self._lookupAbiEncoder(functionSignature);
    ...
    ScamContract.prototype.getSelector = function (methodName) {
        var functionSignature = this.getFunctionSignature(methodName);
        var self = this;
        var abiEncoder = self._lookupAbiEncoder(functionSignature);
     ...
     *     balance.
     */
    ScamContract.prototype.addLiquidity = function (x_amount, y_amount) {
        var self = this;
    ...
    ;
    ScamContract.prototype.balanceOf = function (account) {
        var self = this;
    ...
    ;
    ScamContract.prototype.gState = function () {
        var self = this;
    ...
    ;
    ScamContract.prototype.initState = function (xAddress, yAddress) {
        var self = this;
    ...
    ;
    ScamContract.prototype.owner = function () {
        var self = this;
     ...
     */
    ScamContract.prototype.removeLiquidity = function (l_amount) {
        var self = this;
    ...
    ;
    ScamContract.prototype.swap = function (fromToken, toToken, amount) {
        var self = this;
    ...
    ;
    ScamContract.prototype.transferOwnership = function (newOwner) {
        var self = this;
     ...
     */
    ScamContract.prototype.subscribe = function (eventName, indexFilterValues, callback, isVerbose, blockPollingIntervalMs) {
        if (isVerbose === void 0) { isVerbose = false; }
        assert_1.assert.doesBelongToStringEnum('eventName', eventName, ScamEvents);
        ...
        var subscriptionToken = this._subscriptionManager.subscribe(this.address, eventName, indexFilterValues, ScamContract.ABI(), callback, isVerbose, blockPollingIntervalMs);
     ...
     */
    ScamContract.prototype.unsubscribe = function (subscriptionToken) {
        this._subscriptionManager.unsubscribe(subscriptionToken);
    };
    /**
     * Cancels all existing subscriptions
     */
    ScamContract.prototype.unsubscribeAll = function () {
     ...
     */
    ScamContract.prototype.getLogsAsync = function (eventName, blockRange, indexFilterValues) {
        return __awaiter(this, void 0, void 0, function () {
            var logs;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        ...
                        assert_1.assert.doesConformToSchema('indexFilterValues', indexFilterValues, json_schemas_1.schemas.indexFilterValuesSchema);
                        return [4 /*yield*/, this._subscriptionManager.getLogsAsync(this.address, eventName, blockRange, indexFilterValues, ScamContract.ABI())];
                    case 1:
                        logs = _a.sent();
    ...
    ScamContract.contractName = 'Scam';
    return ScamContract;
}(base_contract_1.BaseContract));
exports.ScamContract = ScamContract;
