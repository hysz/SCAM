...
var MigrationsContract = /** @class */ (function (_super) {
    ...
    function MigrationsContract(address, supportedProvider, txDefaults, logDecodeDependencies, deployedBytecode) {
        if (deployedBytecode === void 0) { deployedBytecode = MigrationsContract.deployedBytecode; }
        var _this = _super.call(this, 'Migrations', MigrationsContract.ABI(), address, supportedProvider, txDefaults, logDecodeDependencies, deployedBytecode) || this;
        _this._methodABIIndex = {};
        utils_1.classUtils.bindAll(_this, ['_abiEncoderByFunctionSignature', 'address', '_web3Wrapper']);
        MigrationsContract.ABI().forEach(function (item, index) {
    ...
    MigrationsContract.deployFrom0xArtifactAsync = function (artifact, supportedProvider, txDefaults, logDecodeDependencies) {
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_d) {
                ...
                return [2 /*return*/, MigrationsContract.deployAsync(bytecode, abi, provider, txDefaults, logDecodeDependenciesAbiOnly)];
            });
        });
    };
    MigrationsContract.deployAsync = function (bytecode, abi, supportedProvider, txDefaults, logDecodeDependencies) {
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 3:
                        ...
                        contractInstance = new MigrationsContract(txReceipt.contractAddress, provider, txDefaults, logDecodeDependencies);
     ...
     */
    MigrationsContract.ABI = function () {
        var abi = [
            {
                inputs: [],
                outputs: [],
    ...
    MigrationsContract.prototype.getFunctionSignature = function (methodName) {
        var index = this._methodABIIndex[methodName];
        var methodAbi = MigrationsContract.ABI()[index]; // tslint:disable-line:no-unnecessary-type-assertion
        var functionSignature = base_contract_1.methodAbiToFunctionSignature(methodAbi);
        return functionSignature;
    };
    MigrationsContract.prototype.getABIDecodedTransactionData = function (methodName, callData) {
    ...
    MigrationsContract.prototype.getABIDecodedReturnData = function (methodName, callData) {
        var functionSignature = this.getFunctionSignature(methodName);
        var self = this;
        var abiEncoder = self._lookupAbiEncoder(functionSignature);
    ...
    MigrationsContract.prototype.getSelector = function (methodName) {
        var functionSignature = this.getFunctionSignature(methodName);
        var self = this;
        var abiEncoder = self._lookupAbiEncoder(functionSignature);
        return abiEncoder.getSelector();
    };
    MigrationsContract.prototype.last_completed_migration = function () {
        var self = this;
        var functionSignature = 'last_completed_migration()';
        return {
    ...
    ;
    MigrationsContract.prototype.owner = function () {
        var self = this;
    ...
    ;
    MigrationsContract.prototype.setCompleted = function (completed) {
        var self = this;
        assert_1.assert.isBigNumber('completed', completed);
        var functionSignature = 'setCompleted(uint256)';
        return {
            ...
            getABIEncodedTransactionData: function () {
                return self._strictEncodeArguments(functionSignature, [completed
                ]);
            },
        };
    };
    ;
    MigrationsContract.prototype.upgrade = function (new_address) {
        var self = this;
        assert_1.assert.isString('new_address', new_address);
        var functionSignature = 'upgrade(address)';
        return {
            sendTransactionAsync: function (txData, opts) {
                if (opts === void 0) { opts = { shouldValidate: true }; }
                return __awaiter(this, void 0, void 0, function () {
            ...
            getABIEncodedTransactionData: function () {
                return self._strictEncodeArguments(functionSignature, [new_address.toLowerCase()
                ]);
            },
        };
    };
    ;
    MigrationsContract.contractName = 'Migrations';
