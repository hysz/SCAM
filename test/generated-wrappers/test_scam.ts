...
export type TestScamEventArgs =
    ...
    | TestScamFillInternalEventArgs
    | TestScamOwnershipTransferredEventArgs
...
export interface TestScamFillInternalEventArgs extends DecodedLogArgs {
    from: string;
    amountSpent: BigNumber;
    amountReceived: BigNumber;
}

export interface TestScamOwnershipTransferredEventArgs extends DecodedLogArgs {
    oldOwner: string;
    newOwner: string;
}
...
> {
    ...
    public runBasicTestPeter(
    ): ContractTxFunctionObj<void
> {
        const self = this as any as TestScamContract;
        const functionSignature = 'runBasicTestPeter()';
